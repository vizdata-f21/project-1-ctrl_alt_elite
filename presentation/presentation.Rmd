...
```{r pic}
## trying to add a picture of Dubois onto the intro slide
```
...
```{r question-one-plot-one, echo = FALSE, out.width = "72%"}
...
.pull-right[
- Seeking to understand what the most popular 
locations at the time of tweets were for the #DuBoisChallenge.

- Shows most of the Twitter challenge activity is occurring in the US

- Most represented home location is in New York
...
```{r question-one-plot-two-northeast, warning = FALSE, echo = FALSE, fig.width = 8}
...
.pull-right[
- Which areas of the world published the most tweets during the challenge and 
 how did the number of  tags in a tweet vary across the globe?
 
- Focuses on NE US since that is where most users assigned their location

- Increased tag count in NYC could be due to the city's historical ties to 
 WEB Du Bois and its cultural significance with the 
...
.pull-left[
- UK is the most active location in Europe

- Map matches our first visualization’s findings that 
 the UK and Austria hold most of the data
 
- Most populated countries in Europe > makes sense to have the most
  number of people tagged in their tweets
]
